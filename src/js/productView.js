  ...
  #createProductItem(product) {
    ...
    <tr class="bg-white text-gray-700 dark:bg-slate-600 dark:text-white hover:bg-gray-100 dark:hover:bg-slate-700 border-b dark:border-gray-700">
      ...
      <td class="px-6 py-4 flex items-center gap-x-3" data-id="${product.id}">
        <svg data-action="edit" class="group hover:cursor-pointer" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg data-action="remove" class="group hover:cursor-pointer" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
